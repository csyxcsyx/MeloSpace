...
> 状态：已完成。完成内容包括技术路线、版本基线、目录策略、MVP/P1/P2 边界、媒体与版权策略，并已提交推送到远程仓库。
...
- [x] 技术路线、版本基线、目录策略已确认。
- [x] 页面清单、普通用户流程、管理员流程和演示主线已确认。
- [x] ER 初稿和 API 初稿已覆盖 P0/P1 核心能力。
- [x] `git status` 中不出现待提交的 FLAC 文件。
- [x] 步骤一文档、媒体清单和忽略规则已提交并推送。
